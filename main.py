...
def get_conversational_chain():
    prompt_template = """
    If anyone asks who you are tell them that Your name is Theta. You are created by Pranav Lejith also known as Amphibiar.
    ...
    They can also ask questions from outside the context, so if it is not in the context, give the answer from the internet.
